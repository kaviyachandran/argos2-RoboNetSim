...
/**
 * @file <argos2/simulator/sensors/epuck/epuck_front_camera_sensor.h>
 *
 * @brief Modified copy/paste of the FootBot ceilling camera sensor done by Carlo Pinciroli - <cpinciro@ulb.ac.be>.
 *
 * @author Mikael Lenaertz <miklenae@ulb.ac.be>
 */

#ifndef EPUCK_FRONT_CAMERA_SENSOR_H
#define EPUCK_FRONT_CAMERA_SENSOR_H

#include <string>
#include <map>

namespace argos {
   class CEpuckFrontCameraSensor;
   class CSpace;
}

#include <argos2/common/control_interface/e-puck/ci_epuck_front_camera_sensor.h>
#include <argos2/simulator/sensors/epuck/epuck_sensor.h>
...
namespace argos {
   ...
   class CEpuckFrontCameraSensor : public CEPuckSensor, public CCI_EpuckFrontCameraSensor {

   public:

      CEpuckFrontCameraSensor();
      virtual ~CEpuckFrontCameraSensor() {}
