...
/**
 * @file argos2/common/utility/argos_random.h
 *
 ...
 * The class argos::CARGoSRandom is a static factory that creates argos::CARGoSRandom::CRNG
 ...
 * argos::CARGoSRandom::CRNG objects in the <tt>argos</tt> category. If, instead, you intend to
 ...
 * <pre>
 * argos::CARGoSRandom::CRNG* m_pcRNG = argos::CARGoSRandom::CreateRNG("argos");
 * </pre>
 *
 ...
 *
 * <pre>
 * argos::CARGoSRandom::CreateCategory("my_category", my_seed);
 * </pre>
 *
 * Once the category is created, you can get a new RNG with a call to the function
 *
 * <pre>
 * argos::CARGoSRandom::CRNG* m_pcRNG = argos::CARGoSRandom::CreateRNG("my_category");
 * </pre>
 *
...
namespace argos {
   ...
   public:
       ...
       * to be able to generate ramdom numbers.
       */
